...
export const init = () => {
	...
	// let corner = new THREE.Vector3(obstacle.position.y + obstacle.geometry.parameters.height/2, obstacle.position.x + obstacle.geometry.parameters.width/2, 0);
	// var vector = new THREE.Vector3( 1, 0, 0 );
	// var axis = new THREE.Vector3( 0, 0, 1 );
	// var angle = Math.PI / 4;
	// console.log(corner);
	// corner.applyAxisAngle( axis, angle );
	// console.log(corner);
	console.log(obstacle.points[0].x.toFixed(4), obstacle.points[0].y.toFixed(4));
